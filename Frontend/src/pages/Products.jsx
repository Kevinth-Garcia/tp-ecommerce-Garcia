...
export default function Products() {
  ...
  useEffect(() => {
    //para llamar a la Api para hacer una peticion, exito guarda los datos, mensaje de error por si falla,desactiva el estado de carga para que no se congele la app//
    fetchProducts()
  ...
  const section = (
    title,
    arr //ordenar la secciones de acuerdo a su categoria con scroll lateral//
  ) => (
