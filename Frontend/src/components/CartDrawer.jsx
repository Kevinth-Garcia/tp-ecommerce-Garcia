...
export default function CartDrawer() {//funcion para abrir el carro off canvas//
 ...
 const handleCheckout = () => {//handle que usa condicional para verificar si tiene o no items en el carro
  if (items.length === 0) {
      ...
      <aside className="cart-drawer" role="dialog" aria-modal="true">
        ...
        <div className="cart-body">
          {items.length === 0 ? (
            ...
            items.map((it) => (//mapeo para que tome los items y sus//
